...
//企业付款
class WxPayExtract extends WxPayDataBase{
    /**
     * 随机字符串
     * @param string $value
     **/
    ...
    /**
     * 获取微信分配的账号ID（企业号corpid即为此appId）的值
     * @return 值
     **/
    ...
    /**
     * 判断微信分配的账号ID（企业号corpid即为此appId）是否存在
     * @return true 或 false
     **/
...
//app支付统一下单
class WxAppPayUnifiedOrder extends WxPayDataBase{
    /**
    ...
    /**
     * 获取该字段用于统一下单时上报场景信息，目前支持上报实际门店信息。值
     * @return 值
     **/
    ...
    /**
     * 判断该字段用于统一下单时上报场景信息，目前支持上报实际门店信息。是否存在
     * @return true 或 false
     **/
